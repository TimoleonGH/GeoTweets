...
public class RealmBackupRestore {
    ...
    private String EXPORT_REALM_FILE_NAME = "exportedSS.realm";
    private String IMPORT_REALM_FILE_NAME = "SylvesterRealm.realm"; // Eventually replace this if you're using a custom db name
